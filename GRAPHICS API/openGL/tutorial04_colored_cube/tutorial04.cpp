...
int main( void )
{
	...
	for (int v = 0; v < 12 * 3; v++) {
		g_color_buffer_data[3 * v + 0] = 0.583f;
		g_color_buffer_data[3 * v + 1] = 0.771f;
		g_color_buffer_data[3 * v + 2] = 0.014f;
	}
	...
	// Projection matrix : 45?Field of View, 4:3 ratio, display range : 0.1 unit <-> 100 units
	glm::mat4 Projection2 = glm::perspective(glm::radians(90.0f), 4.0f / 3.0f, 0.1f, 100.0f);
	// Camera matrix
